pokemon_encouraging_messages_list = [
  ...
  "\"If you need to make a difficult decision and you let someone else decide for you, you will regret it, no matter how it turns out.\" ― Trainer on Route 104, *RSE*",
